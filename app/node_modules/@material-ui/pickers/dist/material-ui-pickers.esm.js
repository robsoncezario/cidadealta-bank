...
import React__default, { createContext, useMemo, createElement, useContext, useRef, useCallback, useState, useEffect, useLayoutEffect, useDebugValue, Component, Fragment, memo, useReducer, cloneElement, forwardRef } from 'react';
import { func, oneOfType, object, string, node, bool, number, instanceOf, oneOf } from 'prop-types';
...
import { makeStyles, styled, withStyles, createStyles, fade, useTheme } from '@material-ui/core/styles';
...
var PenIcon = createSvgIcon(createElement("path", {
...
var PickerToolbar = function PickerToolbar(_ref) {
  ...
  }, isMobileKeyboardViewOpen ? createElement(CalendarIcon, {
    color: "inherit"
...
export { Calendar, CalendarView, Clock, ClockView, DatePicker, DateRangeDelimiter, DateRangePicker, DateTimePicker, Day, DesktopDatePicker, DesktopDateRangePicker, DesktopDateTimePicker, DesktopTimePicker, LocalizationProvider, MobileDatePicker, MobileDateRangePicker, MobileDateTimePicker, MobileTimePicker, MuiPickersAdapterContext as MuiPickersContext, Picker, StaticDatePicker, StaticDateRangePicker, StaticDateTimePicker, StaticTimePicker, TimePicker, ClockView$1 as TimePickerView, defaultReduceAnimations, getTextFieldAriaText$1 as getTextFieldAriaText, makePickerWithStateAndWrapper as makePickerWithState, makeRangePicker, useDateRangeValidation, usePickerState, useStyles$m as useStyles, useUtils };
