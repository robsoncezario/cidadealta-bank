(function (global, factory) {
  ...
  (global = global || self, factory(global['@material-ui/pickers'] = {}, global.React, global['material-ui'].Grid, global['material-ui'].Typography, global['material-ui'].IconButton, global['material-ui'].Toolbar, global['material-ui'].utils, global['material-ui'], global['material-ui'].useMediaQuery, global['material-ui'].Button, global['material-ui'].DialogActions, global['material-ui'].DialogContent, global['material-ui'].Dialog, global['material-ui'].InputAdornment, global['material-ui'].Popover, global['material-ui'].Grow, global['material-ui'].Paper, global['material-ui'].TrapFocus, global['material-ui'].Popper, global['material-ui'].ButtonBase, global['material-ui'].CircularProgress, global.ReactDOM, global['material-ui'].Fade, global['material-ui'].Tab, global['material-ui'].Tabs));
}(this, (function (exports, React, Grid, Typography, IconButton, Toolbar, utils, styles$1, useMediaQuery, Button, DialogActions, DialogContent, Dialog, InputAdornment, Popover, Grow, Paper, TrapFocus, Popper, ButtonBase, CircularProgress, ReactDOM, Fade, Tab, Tabs) { 'use strict';
  ...
  */
  ...
  var PenIcon = utils.createSvgIcon(React.createElement("path", {
  ...
  var CalendarIcon = utils.createSvgIcon(React.createElement("path", {
  ...
  var PickerToolbar = function PickerToolbar(_ref) {
    ...
    }, isMobileKeyboardViewOpen ? React.createElement(CalendarIcon, {
      color: "inherit"
  ...
  var MobileWrapper = function MobileWrapper(_ref) {
    ...
    return React.createElement(WrapperVariantContext.Provider, {
      value: "mobile"
    }, React.createElement(PureDateInputComponent, _extends({}, other, DateInputProps)), React.createElement(ModalDialog, _extends({
      wider: wider,
      showTabs: showTabs,
      open: open,
      onClear: onClear,
  ...
  function useMaskedInput(_ref) {
    ...
    return _objectSpread$1({}, inputStateArgs, {
      label: label,
      disabled: disabled,
  ...
  var KeyboardDateInput = function KeyboardDateInput(_ref) {
    var renderInput = _ref.renderInput,
        ...
        openPickerIcon = _ref$openPickerIcon === void 0 ? React.createElement(CalendarIcon, null) : _ref$openPickerIcon,
    ...
    return renderInput(_objectSpread$2({
      ref: containerRef,
      inputRef: forwardedRef
    }, textFieldProps, {
  ...
  var DesktopWrapper = function DesktopWrapper(_ref) {
    ...
    return React.createElement(WrapperVariantContext.Provider, {
      value: "desktop"
    }, React.createElement(KeyboardDateInputComponent, _extends({}, DateInputProps, {
      containerRef: ref
  ...
  var StaticWrapper = function StaticWrapper(_ref) {
    ...
    return React.createElement(IsStaticVariantContext.Provider, {
      value: true
    }, React.createElement(WrapperVariantContext.Provider, {
  ...
  var createIsAfterIgnoreDatePart = function createIsAfterIgnoreDatePart(disableTimeValidationIgnoreDatePart, utils) {
  ...
  var validateTime = function validateTime(utils, value, _ref) {
    ...
    var date = utils.date(value);
    var isAfterComparingFn = createIsAfterIgnoreDatePart(Boolean(disableTimeValidationIgnoreDatePart), utils);
  ...
  var useStyles$a = styles$1.makeStyles({
    separator: {
      outline: 0,
      margin: '0 4px 0 2px',
      cursor: 'default'
  ...
  var ArrowLeftIcon = utils.createSvgIcon(React.createElement("path", {
  ...
  var ArrowRightIcon = utils.createSvgIcon(React.createElement("path", {
  ...
  var useStyles$c = styles$1.makeStyles(function () {
    return {
      arrowSwitcher: {
        position: 'absolute',
        right: 8,
  ...
  var ClockView = function ClockView(_ref) {
    ...
    var isTimeDisabled = React.useCallback(function (rawValue, type) {
      var validateTimeValue = function validateTimeValue(getRequestedTimePoint) {
        var isAfterComparingFn = createIsAfterIgnoreDatePart(Boolean(disableTimeValidationIgnoreDatePart), utils); // prettier-ignore
  ...
  var useStyles$e = styles$1.makeStyles({
    container: {
      width: 310,
      display: 'flex',
      flexWrap: 'wrap',
  ...
  var ArrowDropDownIcon = utils.createSvgIcon(React.createElement("path", {
    d: "M7 10l5 5 5-5z"
  }), 'ArrowDropDown');
  ...
  var useStyles$n = styles$1.makeStyles({
    container: {
      display: 'flex',
      flexDirection: 'column'
    },
  ...
  function Picker(_ref) {
    ...
    var wrapperVariant = React.useContext(WrapperVariantContext);
    var handleDateChange = React.useCallback(function (date, isFinish) {
  ...
  function makePickerWithStateAndWrapper(Wrapper, _ref) {
    ...
    function PickerWithState(__props) {
      ...
      var DateInputProps = _objectSpread$4({}, inputProps, {}, other, {
      ...
      return React.createElement(PickerWrapper, _extends({
        ...
        wrapperProps: wrapperProps
      }, other), React.createElement(Picker, _extends({}, pickerProps, {
  ...
  var ClockIcon = utils.createSvgIcon(React.createElement(React.Fragment, null, React.createElement("path", {
  ...
  var TimeIcon = utils.createSvgIcon(React.createElement(React.Fragment, null, React.createElement("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), React.createElement("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
  })), 'Time');
  ...
  var DateRangeIcon = utils.createSvgIcon(React.createElement("path", {
  ...
  var useStyles$q = styles$1.makeStyles({
    penIcon: {
      position: 'relative',
      top: 4
    },
  ...
  var DateRangePickerInput = function DateRangePickerInput(_ref) {
    ...
    var startInputProps = useMaskedInput(_objectSpread$9({}, other, {
      readOnly: readOnly,
      rawValue: start,
      onChange: handleStartChange,
      label: startText,
      validationError: startValidationError !== null,
      TextFieldProps: _objectSpread$9({}, TextFieldProps, {
        ref: startRef,
        variant: 'outlined',
    ...
    var endInputProps = useMaskedInput(_objectSpread$9({}, other, {
      readOnly: readOnly,
      label: endText,
      rawValue: end,
  ...
  var DateRangePickerView = function DateRangePickerView(_ref) {
    ...
    var renderView = function renderView() {
      var sharedCalendarProps = _objectSpread$a({
        date: date,
        isDateDisabled: isDateDisabled,
        changeFocusedDay: changeFocusedDay,
        onChange: handleChange,
    ...
    return React.createElement("div", {
      className: className
    }, toShowToolbar && React.createElement(DateRangePickerToolbar, {
      date: date,
      isMobileKeyboardViewOpen: isMobileKeyboardViewOpen,
      toggleMobileKeyboardView: toggleMobileKeyboardView,
      currentlySelectingRangeEnd: currentlySelectingRangeEnd,
  ...
  var DateRangeDelimiter = styles$1.styled(Typography)({
    margin: '0 16px'
  });
  ...
  function makeRangePicker(Wrapper) {
    ...
    function RangePickerWithStateAndWrapper(_ref) {
      ...
      var pickerStateProps = _objectSpread$b({}, other, {
        value: value,
        onChange: onChange,
        inputFormat: passedInputFormat || utils.formats.keyboardDate
      });

      var restProps = _objectSpread$b({}, other, {
        minDate: minDate,
        maxDate: maxDate
      });
      ...
      var DateInputProps = _objectSpread$b({}, inputProps, {}, restProps, {
        currentlySelectingRangeEnd: currentlySelectingRangeEnd,
        setCurrentlySelectingRangeEnd: setCurrentlySelectingRangeEnd,
        startText: startText,
        endText: endText,
      ...
      return React.createElement(WrapperComponent, _extends({
        wrapperProps: wrapperProps,
        DateInputProps: DateInputProps
      }, restProps), React.createElement(DateRangePickerView, _extends({
