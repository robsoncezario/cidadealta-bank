...
var LuxonUtils = /** @class */ (function () {
    ...
    LuxonUtils.prototype.addSeconds = function (date, count) {
        return count < 0
            ? date.minus({ seconds: Math.abs(count) })
            : date.plus({ seconds: count });
    };
    LuxonUtils.prototype.addMinutes = function (date, count) {
        return count < 0
            ? date.minus({ minutes: Math.abs(count) })
            : date.plus({ minutes: count });
    };
    LuxonUtils.prototype.addHours = function (date, count) {
        return count < 0
    ...
    LuxonUtils.prototype.addWeeks = function (date, count) {
        return count < 0
    ...
    LuxonUtils.prototype.getDiff = function (value, comparing, unit) {
    ...
    LuxonUtils.prototype.getDaysInMonth = function (value) {
