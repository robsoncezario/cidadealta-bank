...
var MomentUtils = /** @class */ (function () {
    ...
    MomentUtils.prototype.getDiff = function (date, comparing, unit) {
    ...
    MomentUtils.prototype.addSeconds = function (date, count) {
        return count < 0
            ? date.clone().subtract(Math.abs(count), "seconds")
            : date.clone().add(count, "seconds");
    };
    MomentUtils.prototype.addMinutes = function (date, count) {
        return count < 0
            ? date.clone().subtract(Math.abs(count), "minutes")
            : date.clone().add(count, "minutes");
    };
    MomentUtils.prototype.addHours = function (date, count) {
        return count < 0
    ...
    MomentUtils.prototype.addWeeks = function (date, count) {
        return count < 0
